...
import com.example.java_bank_app_demo.repository.UserRepository;
import com.example.java_bank_app_demo.utils.AccountUtils;
...
public class UserServiceImpl implements UserService{
    ...
    public BankResponse loginAccount(UserRequest userRequest) {
        ...
        // Invalid login credentials response
        return BankResponse.builder()
                        .responseCode(AccountUtils.LOGIN_FAIL_CODE)
                        .responseMessage(AccountUtils.LOGIN_FAIL_MESSAGE)
                        .accountInfo(null)
                        .build();
    }
